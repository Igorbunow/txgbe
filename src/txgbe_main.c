...
#define DRV_VERSION     __stringify(1.3.6klos)
#elif defined(CONFIG_EULER_KERNEL)
#define DRV_VERSION     __stringify(1.3.6elos)
#elif defined(CONFIG_UOS_KERNEL)
#define DRV_VERSION     __stringify(1.3.6uos)
#else
#define DRV_VERSION     __stringify(1.3.6)
#endif
